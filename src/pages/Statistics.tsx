                ...
                <table className="w-full text-sm">
                  <thead className="bg-muted/30">
                    <tr className="text-left text-xs uppercase tracking-wider text-muted-foreground font-mono">
                      ...
                      <th className="px-3 py-2 w-[180px]">Folder</th>
                      <th className="px-3 py-2 w-[120px]">Scene</th>
                  ...
                  <tbody>
                    {history.map((h) => {
                      ...
                      const folderText = [p?.block_letter, p?.block_label].filter(Boolean).join(' · ') || '—';
                      const sceneText = p?.internal_name || p?.question || '—';
                      return (
